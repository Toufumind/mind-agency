...
import { getConsensusProxy } from '../src/lib/consensus-proxy';

describe('Consensus Proxy', () => {
  it('should get consensus proxy', () => {
    const proxy = getConsensusProxy();
