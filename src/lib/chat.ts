...
【工具速查】
重要：MCP工具暂不可用，请使用以下文件系统工具：
读取文件: Read(file_path="D:/Projects/Git/Mind/534/Groups/<name>/workflow.yaml")
写入文件: Write(file_path="...", content="...")
编辑文件: Edit(file_path="...", old_string="...", new_string="...")
执行命令: Bash(command="...")

文件路径:
- 工作流: D:/Projects/Git/Mind/534/Groups/<name>/workflow.yaml
- 邮件: D:/Projects/Git/Mind/534/Agents/<name>/email/
- 群组消息: D:/Projects/Git/Mind/534/Groups/<name>/chat/
- 记忆: D:/Projects/Git/Mind/534/.mind/agents/<name>/

完成工作流任务后，在回复中包含：
workflow_callback(runId="...", stepId="...", status="COMPLETED", summary="...")
始终用中文回复。`;
